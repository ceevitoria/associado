...
@NamedQueries({ 
	@NamedQuery(name = "OcorrenciaEntity.querySel", query = "select obj.id as id, obj.tipo as tipo, obj.data as data, obj.valor as valor, obj.descricao as descricao, obj.versao as versao, obj1.id as associado_id, obj1.versao as associado_versao, obj2.id as associado_pessoa_id, obj2.nome as associado_pessoa_nome, obj2.versao as associado_pessoa_versao from OcorrenciaEntity obj inner join obj.associado obj1 inner join obj1.pessoa obj2 order by obj.data asc"),
